...
export const MESSAGE_EVENT_DEFAULTS: Record<string, { group: string; description: string; text: string; expectsResponse?: boolean }> = {
  ...
  profile_name_prompt: { group: 'Coleta de Perfil', description: 'Solicita nome', text: 'Por favor, informe seu nome.', expectsResponse: true },
  profile_company_prompt: { group: 'Coleta de Perfil', description: 'Solicita empresa', text: 'Por favor, informe a empresa.', expectsResponse: true },
  profile_email_prompt: { group: 'Coleta de Perfil', description: 'Solicita e-mail', text: 'Se tiver, informe seu e-mail para cadastro.', expectsResponse: true },
  profile_equipment_prompt: { group: 'Coleta de Perfil', description: 'Solicita equipamento', text: 'Informe o equipamento ou sistema afetado.', expectsResponse: true },
